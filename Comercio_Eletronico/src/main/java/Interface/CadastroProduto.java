...
public class CadastroProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxTipoProduto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Moveis", "Eletrodomesticos", "Eletronicos", "Vestuario" }));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(textCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(textFabricante, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel6)))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(cbxTipoProduto, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void buttonCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCadastroActionPerformed
        ...
        String tipo = (String) cbxTipoProduto.getSelectedItem();

        String[] values = {codigo, nome, codigo, descricao, fabricante, valor, tipo};
        if(Utils.hasNull(values)){
            ...
            JOptionPane.showMessageDialog(this, "Código do produto precisa ser um valor numérico!",
                    "Atenção", JOptionPane.WARNING_MESSAGE);
            textCodigo.setText("");
        } else if(!Utils.isFloat(valor)){
            JOptionPane.showMessageDialog(this,"Valor do produto deve ser colocado em reais (EX: 00.00)",
                    "Atenção", JOptionPane.WARNING_MESSAGE);
            textValor.setText("");
        }
            ...
            controller.addProduto(tipo, Integer.parseInt(codigo), nome, descricao,
                    dataFabricacao, Float.parseFloat(valor), fabricante);
            textCodigo.setText("");
            textNome.setText("");
